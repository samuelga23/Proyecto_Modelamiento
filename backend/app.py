...
def simulate():
    try:
        ...
        Q_out = Q_out_Lmin / 1000.0 # Convertir de L/min a m^3/min si Q_out está en m^3
        ...
        if rain_intervals:
            ...
            t_points = [0.0, total_minutes]
            intensity_mm_h = rainfall / duration_h if duration_h > 0 else 0
            intensities = [intensity_mm_h, 0.0] # Un patrón uniforme simple que termina en 0
        ...
        main_path = os.path.join(octave_scripts_path, 'main.m')
